...
public class DemoApp {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            System.out.println("Configurations read from " + args[0]);
    ...
    private static void StatusConfirmationCCT() {
        try {
            ...
            com.swift.sdk.gpi.tracker.v5.status.update.cct.ApiResponse resp = status.statusConfirmationsWithHttpInfo(uetr, reqBody);
    ...
    private static void StatusConfirmationCOV() {
        try {
            ...
            status.setBasePath(basePath);
            com.swift.sdk.gpi.tracker.v5.status.update.cov.ApiResponse resp = status.statusConfirmationsWithHttpInfo(uetr, reqBody);
    ...
    private static void StatusConfirmationFIT() {
        try {
            ...
            status.setBasePath(basePath);
            com.swift.sdk.gpi.tracker.v5.status.update.fit.ApiResponse resp = status.statusConfirmationsWithHttpInfo(uetr, reqBody);
    ...
    private static void StatusConfirmationINST() {
        try {
            ...
            status.setBasePath(basePath);
            com.swift.sdk.gpi.tracker.v5.status.update.inst.ApiResponse resp = status.statusConfirmationsWithHttpInfo(uetr, reqBody);
    ...
    private static void StatusConfirmationUni() {
        try{
            ...
            status.setBasePath(basePath);
            com.swift.sdk.gpi.tracker.v5.status.update.universal.ApiResponse resp = status.statusConfirmationsWithHttpInfo(uetr,reqBody);
    ...
    private static void getPaymentTransactionDetails() {
        try{
            ...
            status.setBasePath(basePath);
            com.swift.sdk.gpi.tracker.v5.transactionsandcancellations.ApiResponse resp = status.getPaymentTransactionDetailsWithHttpInfo(uetr);
    ...
    private static void getChangedPaymentTransaction() {
        try{
            ...
            String basePath = connectionInfo.getGatewayHost() + "/swift-apitracker/v5";
            status.setBasePath(basePath);
            com.swift.sdk.gpi.tracker.v5.transactionsandcancellations.ApiResponse resp = status.getChangedPaymentTransactionsWithHttpInfo(fromDateTime, toDateTime, maxNumber, paymentScenario, next);
    ...
    private static void CancelTransaction() {
        try{
            com.swift.sdk.gpi.tracker.v5.transactionsandcancellations.api.CancelTransactionApi status = new CancelTransactionApi(connectionInfo);
            ...
            String basePath = connectionInfo.getGatewayHost() + "/swift-apitracker/v5";
            status.setBasePath(basePath);
            String sig = status.nrSign(connectionInfo.getGatewayHost() + "/swift-apitracker/v5", reqBody);
            com.swift.sdk.gpi.tracker.v5.transactionsandcancellations.ApiResponse resp = status.cancelTransactionWithHttpInfo(reqBody, sig.getBytes(StandardCharsets.UTF_8), uetr);
    ...
    private static void TransactionCancellationStatus() {
        try{
            com.swift.sdk.gpi.tracker.v5.transactionsandcancellations.api.TransactionCancellationStatusApi status = new TransactionCancellationStatusApi(connectionInfo);
            ...
            status.setBasePath(basePath);
            String sig = status.nrSign(connectionInfo.getGatewayHost() + "/swift-apitracker/v5", reqBody);
            com.swift.sdk.gpi.tracker.v5.transactionsandcancellations.ApiResponse resp = status.transactionCancellationStatusWithHttpInfo(reqBody, sig.getBytes(StandardCharsets.UTF_8),uetr);
